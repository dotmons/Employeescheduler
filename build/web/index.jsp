...
<html lang="en">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="alert alert-info alert-dismissable">
                                <i class="fa fa-info-circle"></i>  <strong>Welcome <s:property value="username"/></strong> 
                            </div>
                        </div>
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-8">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i> Employee Chart</h3>
                                </div>
    ...
    Morris.Donut({
        ...
        data: [{
            label: "Manager",
            value: "<s:property value="managernumb"/>"
        }, {
            label: "Employee",
            value: "<s:property value="staffnumb"/>"
        }],
        resize: true
    });
